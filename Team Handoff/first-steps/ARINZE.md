...
## 1. Commit the working tree · 10 min — DO THIS FIRST

~50 modified files are uncommitted, including the entire Season One integration. Nobody can branch cleanly until this lands.
...
git push
git branch feat/minigames && git branch feat/ui && git branch feat/ch12
git push --all
```

**Done when:** `git status` is clean, branches pushed.
**Unblocks:** Luca and Ben.
